"""
phytologue.core.learned — ϕ as ML model.
...
class LearnedModel(Protocol):
    ...
    Implementations live in phytologue.adapters.  An implementation MUST:
        * carry a `name` attribute (free-form string for ticker logging)
        * carry a `device` attribute that came from phytologue.device
